...
if (LINUX OR DARWIN)
  ...
  elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang" OR "${CMAKE_CXX_COMPILER_ID}" STREQUAL "AppleClang")
    ...
    set(UNIX_WARNINGS "-Wall -Wno-inconsistent-missing-override -Wno-sign-compare -Wno-trigraphs -Wno-tautological-compare -Wno-char-subscripts -Wno-gnu -Wno-logical-op-parentheses -Wno-logical-not-parentheses -Wno-non-virtual-dtor -Wno-deprecated")
    ...
    set(UNIX_WARNINGS "${UNIX_WARNINGS} ")
  elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Intel")
